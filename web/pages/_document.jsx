    ...
    return (
      <Html lang="cn">
        ...
        <script dangerouslySetInnerHTML={{__html: `
          ...
          var url = 'http://sdk.talkingdata.com/app/h5/v1?appid=' + appid + '&vn=' + 'discuzq3.0' + '&vc=' + 'v3.0.210727';
          if ( window.location.protocol.indexOf('https') != -1 ) {
            url = 'https://jic.talkingdata.com/app/h5/v1?appid=' + appid + '&vn=' + 'discuzq3.0' + '&vc=' + 'v3.0.210727';
          }

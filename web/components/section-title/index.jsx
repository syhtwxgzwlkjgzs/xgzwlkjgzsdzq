 ...
 */
const Index = ({ icon = {}, title, leftNum, onShowMore, isShowMore = true, rightText, bigSize = false, moreText = '更多', className = '' }) => (
  <div className={`${bigSize ? styles.wrapper : styles.container} ${className}`}>

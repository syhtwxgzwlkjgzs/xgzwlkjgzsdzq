...
const Position = (props) => {
  const { position, lbskey, onChange = () => { }, onClick = () => { } } = props;
  ...
  const showPosition = (value) => {
    ...
    const newMapUrl = `https://apis.map.qq.com/tools/locpicker?search=1&type=1&key=${lbskey}&referer=myapp&coord=${coord}`;

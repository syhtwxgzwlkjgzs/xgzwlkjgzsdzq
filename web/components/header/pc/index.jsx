                        ...
                        <div className={styles.right}>
                            <div className={styles.iconList}>
                                <div className={styles.iconItem}>
                                    <Icon onClick={() => {this.iconClickHandle('home')}} name="HomeOutlined" size={15} />
                                    <p>首页</p>
                                </div>
                                <div className={styles.iconItem}>
                                    <Icon onClick={() => {this.iconClickHandle('home')}} name="MessageOutlined" size={15} />
                                    <p>消息</p>
                                </div>
                                <div className={styles.iconItem}>
                                    <Icon onClick={() => {this.iconClickHandle('home')}} name="FindOutlined" size={15} />
                                    <p>发现</p>
                                </div>
                            </div>
                            {this.renderUserInfo()}

...
import { Icon, Input, Badge, Toast, Popup, Textarea, Upload, Button } from '@discuzq/design';
    ...
    return (
      <div className={layout.container}>
        ...
        <div className={layout.footer}>
          ...
          >
            <div>
              <div className={footer.inputPopup}>
                <Textarea
                  maxLength={5000}
                  rows={5}
                  showLimit={true}
              ...
              <Button className={footer.button} type='primary' size='large'>发布</Button>
            </div>
          </Popup>
          ...
          <div className={footer.operate}>
            ...
            <Icon
              ...
              className={footer.icon} onClick={() => this.onCollectionClick()}
              size='20'
              name='HeartOutlined'>
            </Icon>

            <Icon onClick={() => this.onInputClick()} className={footer.icon} size='20' name='ShareAltOutlined'></Icon>
          </div>
        </div>
      </div>
    );

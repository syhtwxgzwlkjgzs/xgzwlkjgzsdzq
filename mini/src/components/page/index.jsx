...
export default class Page extends React.Component {
  ...
  isPass() {
    ...
    if (site && site.webConfig) {
      ...
      if (user.isLogin()) {
        // // 绑定微信：开启微信，没有绑定微信
        // if ((site.isOpenOffiaccountOpen || site.isMiniProgramOpen) && path !== '/subPages/user/wx-bind-qrcode/index' && !user.isBindWechat) {
        //   Router.redirect({url: '/subPages/user/wx-bind-qrcode/index'});
        //   return false;
        // }
        // 前置：没有开启微信
        if (!site.isOpenOffiaccountOpen && !site.isMiniProgramOpen) {

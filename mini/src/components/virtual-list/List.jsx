            ...
            <>
                {
                    dataSource?.map((item, index) => {
                        ...
                        {
                            item?.map((subItem, subIndex) => (<Thread data={subItem} key={`${subItem.threadId}-${subItem.updatedAt}`} relativeToViewport={displays[index]} dispatch={dispatch} autoplay={subIndex === 0}/>))
                        }
                        </View>
                    )})
                }
